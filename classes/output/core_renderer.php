 ...
 *
 * @package    theme_boost, theme_escribiendo
...
class core_renderer extends \core_renderer {
    ...
    public function render_login(\core_auth\output\login $form) {
        ...
        $context->loginintro = get_config('theme_escribiendo', 'login_intro');
    ...
    public function search_box($id = false) {
      ...
      <span class="input-group-btn">
        ...
        return html_writer::tag('div', $searchinput, array('class' => 'theme_escribiendo-input-wrapper nav-link', 'id' => $id));
    }
